            ...
            >
                <section className="d-flex justify-content-between px-4">
                    ...
                    <div className='socials'>
                        ...
                        <a href="https://www.instagram.com/ayushxpathania/" className="text-white me-4" target="_blank" rel='noreferrer noopener'>
                            <i className="fab fa-instagram"></i>
                        </a>
                        <a href="https://www.linkedin.com/in/ayush-pathania-573804231/" className="text-white me-4" target="_blank" rel='noreferrer noopener'>
                            <i className="fab fa-linkedin"></i>
                        </a>
                        <a href="https://github.com/codeitayush?tab=repositories" className="text-white me-4" target="_blank" rel='noreferrer noopener'>
                        ...
                        <div className="row mt-3">
                            ...
                            <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4 mt-3">
                                ...
                                <hr
                                    className="mb-4 mt-0 d-inline-block mx-auto"
                                />
                                <p><i className="fas fa-home mx-3"></i>Kangra, Himachal Pradesh, IN</p>
                                <p><i className="fas fa-envelope mx-3"></i>ayushpathania994@gmailcom</p>
                                <p><i className="fas fa-phone mx-3"></i>+ 91 9459287128</p>
                            </div>
                        </div>
                    </div>
                </section>
