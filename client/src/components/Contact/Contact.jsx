        ...
        <div className='bg-grey'>
            <div className="contact-conainer">
                ...
                <div className="d-flex mb-3 pt-5 justify-content-between contact-links">
                    ...
                    <a href="mailto:ayushpathania994@gmail.com" className='sendmail'> <EmailIcon className='mx-2 icon' /> ayushpathania994@gmail.com</a>
                </div>
                <div className="d-flex my-3 justify-content-between contact-links">
                    <span className='contact-name text-center'>Instagram </span>
                    <a href="https://www.instagram.com/ayushxpathania/" rel="noreferrer" target="_blank" className='insta'> <InstagramIcon className='mx-2 icon' /> ayushxpathania</a>
                </div>
                <div className="d-flex my-3 justify-content-between contact-links">
                    <span className='contact-name text-center'>LinkedIn </span>
                    <a href="https://www.linkedin.com/in/ayush-pathania-573804231/" rel="noreferrer" target="_blank" className='linkedin'> <LinkedInIcon className='mx-2 icon' /> Ayush Pathania</a>
                </div>
            </div>
        </div>
    )
